...
import { rewardUserApi } from '@/pages/User/UserProfile/api/rewardUser_api';
import { useEffect, useState } from 'react';
import type { rewardsUser } from '@/pages/User/UserProfile/types/rewardUser';
                ...
                <div className="flex-1 p-4 flex  justify-between min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-5 mt-2 pt-2 border-t border-slate-100">
                    ...
                    <button 
                      ...
                      className={`px-4 py-1.5 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm ${
                        isExchanging || (user?.loyalty_points || 0) < (v.required_points || 0)
